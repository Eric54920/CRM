# -*- coding: utf-8 -*-
# Generated by Django 1.11.25 on 2019-11-19 09:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(blank=True, choices=[('Linux', 'Linux中高级'), ('PythonFullStack', 'Python高级全栈开发')], default='Linux', max_length=64, null=True, verbose_name='课程名')),
                ('class_type', models.CharField(blank=True, choices=[('fulltime', '脱产班'), ('online', '网络班'), ('weekend', '周末班')], default='fulltime', max_length=64, null=True, verbose_name='班级类型')),
                ('delete_status', models.BooleanField(default=False, verbose_name='删除状态')),
        ...
        migrations.AddField(
            model_name='courserecord',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_record', to='crm.UserProfile', verbose_name='讲师'),
        ),
        migrations.AddField(
