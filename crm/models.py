...
class Customer(models.Model):
    ...
    def show_status(self):
        ...
        return mark_safe("<span class='{}'>{}</span>".format(
            style_status.get(self.status), self.get_status_display()))
...
class ClassList(models.Model):
    ...
    class_type = models.CharField(choices=class_type_choices,
                                  max_length=64,
                                  verbose_name='班额及类型',
                                  blank=True,
                                  null=True)
    ...
    def __str__(self):
        return f"{self.campuses.name}{self.get_course_display()}{self.get_class_type_display()}{int(self.semester)}期"
...
class ConsultRecord(models.Model):
    ...
    def show_status(self):
        ...
        return mark_safe("<span class='{}'>{}</span>".format(
            style_status.get(self.delete_status), self.delete_status))
...
class Enrollment(models.Model):
    ...
    why_us = models.TextField("为什么报名",
                              max_length=1024,
                              default=None,
                              blank=True,
                              null=True)
    your_expectation = models.TextField("学完想达到的具体期望",
                                        max_length=1024,
                                        blank=True,
                                        null=True)
...
class PaymentRecord(models.Model):
    ...
    缴费记录表
    """
    pay_type = models.CharField("费用类型",
    ...
    class_type = models.CharField("班级类型",
                                  ...
                                  null=True,
                                  default='fulltime')
    enrolment_class = models.ForeignKey('ClassList',
                                        verbose_name='所报班级',
                                        blank=True,
                                        null=True)
    ...
    status = models.IntegerField(verbose_name='审核',
                                 default=1,
    ...
    confirm_date = models.DateField(verbose_name="确认日期",
                                        null=True,
                                        blank=True)
    confirm_user = models.ForeignKey(verbose_name="确认人",
                                     to='UserProfile',
...
class CourseRecord(models.Model):
    ...
    course_title = models.CharField('本节课程标题',
                                    max_length=64,
                                    blank=True,
                                    null=True)
    course_memo = models.TextField('本节课程内容',
                                   max_length=300,
                                   blank=True,
                                   null=True)
    has_homework = models.BooleanField(default=True, verbose_name="本节有作业")
    homework_title = models.CharField('本节作业标题',
                                      max_length=64,
                                      blank=True,
                                      null=True)
    homework_memo = models.TextField('作业描述',
                                     ...
                                     blank=True,
                                     null=True)
    scoring_point = models.TextField('得分点',
                                     max_length=300,
                                     blank=True,
                                     null=True)
    ...
    def __str__(self):
        return f"{self.re_class}-{self.day_num}天"
...
class StudyRecord(models.Model):
    ...
    attendance = models.CharField("考勤",
                                  choices=attendance_choices,
                                  default="checked",
                                  max_length=64)
    score = models.IntegerField("本节成绩", choices=score_choices, default=-1)
    homework_note = models.CharField(max_length=255,
                                     verbose_name='作业批语',
                                     blank=True,
                                     null=True)
